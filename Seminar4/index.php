...
$works = [
  [
    ...
    "dateEnd" => "Февраль 2001",
    "description" => "Описание работы ssssssssssssssssssssssssssssssssss"
  ],
  [
    "name" => "работа 2",
    "dateStart" => "Март 2005",
    "dateEnd" => "декабрь 2003",
    "description" => "Описание работы ыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыы"
  ],
  [
    "name" => "работа 3",
    "dateStart" => "Январь 2014",
    "dateEnd" => "Февраль 2025",
    "description" => "Описание работы ффффффффффффффффффффффффффффффффффффффф"
  ],
];
?>
<!DOCTYPE html>
